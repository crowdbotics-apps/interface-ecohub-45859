"""
Django settings for interface_ecohub_45859 project.
...
ROOT_URLCONF = 'interface_ecohub_45859.urls'
...
WSGI_APPLICATION = 'interface_ecohub_45859.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "interface_ecohub_45859 API",
    "DESCRIPTION": "API documentation for interface_ecohub_45859 App",
    "VERSION": "v1",
}
